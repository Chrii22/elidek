...
<body class="d-flex flex-column min-vh-100">
  ...
  <br><br>
  <div class="container">
    <h4>Top Researchers</h4>
    <p>Table of top researchers younger than 40</p>
  </div>


  <?php
    $query = "SELECT Researcher.firstName, Researcher.lastName, Researcher.age, count(ProjectID) as count
